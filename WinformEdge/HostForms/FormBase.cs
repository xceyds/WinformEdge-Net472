    ...
    protected override void WndProc(ref Message m)
    {
        ...
        switch (msg)
        {
            case WM_NCCREATE when OperatingSystem.IsWindowsVersionAtLeast(10, 0, 14393):
                ...
                break;
            case WM_NCCALCSIZE when wParam == (IntPtr)1 && ExtendsContentIntoTitleBar && !Popup && !Fullscreen:
                {
                ...
                return;
            case WM_NCCALCSIZE when wParam == IntPtr.Zero && !OperatingSystem.IsWindowsVersionAtLeast(10, 0, 22000):
                {
